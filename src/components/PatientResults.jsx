...
const PatientResults = () => {
  ...
  if (loading)
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-gray-600 animate-pulse">Loading assessment results...</p>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center px-4 py-8">
      ...
      <div className="grid grid-cols-2 gap-4 mt-8 w-full max-w-md">
        <button onClick={() => navigate("/assessment")} className="bg-white p-6 rounded-xl shadow-md hover:bg-blue-50">
          🤖 <p className="font-semibold mt-2">AI Symptom Checker</p>
        </button>
        <button onClick={() => navigate("/teleconsultation")} className="bg-white p-6 rounded-xl shadow-md hover:bg-blue-50">
          👨‍⚕️ <p className="font-semibold mt-2">Talk to a Doctor</p>
        </button>
        <button onClick={() => navigate(`/pharmacy/${patientId}`)} className="bg-white p-6 rounded-xl shadow-md hover:bg-blue-50">
          💊 <p className="font-semibold mt-2">Pharmacy</p>
        </button>
        <button onClick={() => navigate("/appointments")} className="bg-white p-6 rounded-xl shadow-md hover:bg-blue-50">
          📅 <p className="font-semibold mt-2">Appointments</p>
        </button>
      </div>
